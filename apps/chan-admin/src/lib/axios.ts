...
export const getx = (url: string, params?: any) => http.get(url, { params }).then((res) => res.data.data)

export const postx = (url: string, data?: any) => http.post(url, data).then((res) => handleRes(res, '添加成功'))

export const delx = (url: string, data?: any) => http.delete(url, { data }).then((res) => handleRes(res, '删除成功'))
