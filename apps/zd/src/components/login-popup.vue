  ...
  <Popup :open="open" @close="close">
    <view class="p-2 py-4">
      <view class="flex items-center justify-center">
        <image src="/static/images/logo-long.png" class="w-218 h-90" />
      </view>
      <view class="pt-4">
        ...
        <view class="flex items-center mt-2" @click="requireAuth">
          ...
          <view class="text-slate-800">查看并确认<text class="text-blue-500" @click="openPrivacyContract">《止动计划隐私协议》</text></view>
        </view>
