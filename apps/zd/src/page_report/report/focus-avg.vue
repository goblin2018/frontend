<template>
  ...
  <view class="flex items-center justify-center relative w-320px h-260px mx-auto">
    <image src="/static/images/avg-bg.png" mode="aspectFit" class="w-full h-full" />
    <image
    ...
    <view class="absolute bottom-0 left-0 flex items-baseline justify-center w-full mt-2">
      <view class="text-4xl font-bold text-black/80 mr-1">{{ value.toFixed(1) }}</view>
