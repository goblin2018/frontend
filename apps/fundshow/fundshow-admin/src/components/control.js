...
const blue = 0x2c8ffb
const red = 0xfd4f54
const green = 0x56e156
const yellow = 0xf8bd4b
...
// 旋转速度调节
const _unit = {
  X: new Vector3(15, 0, 0),
  Y: new Vector3(0, 15, 0),
  Z: new Vector3(0, 0, 1),
}
...
class TransformControlsGizmo extends Object3D {
  constructor() {
    ...
    const scaleHandleGeometry = new SphereGeometry(0.08)
    ...
    const lineGeometry2 = new CylinderGeometry(0.0045, 0.0045, 0.5, 3)
    ...
    const gizmoTranslate = {
      ...
      XYZ: [
        [
          new Mesh(new SphereGeometry(0.1), matWhiteTransparent.clone()),
          [0, 0, 0],
        ],
      ],
      // XY: [
    ...
    const gizmoScale = {
      X: [
        [
          new Mesh(scaleHandleGeometry, matRedTransparent),
          [0.5, 0, 0],
          [0, 0, -Math.PI / 2],
        ],
        [new Mesh(lineGeometry2, matRed), [0, 0, 0], [0, 0, -Math.PI / 2]],
